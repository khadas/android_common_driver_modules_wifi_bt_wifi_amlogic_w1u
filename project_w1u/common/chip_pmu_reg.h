...
#define CHIP_PMU_REG_BASE                         (0xf02000)

#define RG_PMU_A0                                 (CHIP_PMU_REG_BASE + 0x0)
// Bit 15  :0      rg_pmu_pwr_xosc_bnd            U     RW        default = 'h6
typedef union RG_PMU_A0_FIELD
{
  unsigned int data;
  struct
  {
...
#define RG_PMU_A2                                 (CHIP_PMU_REG_BASE + 0x8)
// Bit 15  :0      rg_pmu_xosc_dpll_bnd           U     RW        default = 'h6
typedef union RG_PMU_A2_FIELD
{
  unsigned int data;
  struct
  {
...
#define RG_PMU_A4                                 (CHIP_PMU_REG_BASE + 0x10)
// Bit 15  :0      rg_pmu_dpll_act_bnd            U     RW        default = 'h6
typedef union RG_PMU_A4_FIELD
{
  unsigned int data;
  struct
  {
...
#define RG_PMU_A6                                 (CHIP_PMU_REG_BASE + 0x18)
// Bit 15  :0      rg_pmu_act_sleep_bnd           U     RW        default = 'h6
typedef union RG_PMU_A6_FIELD
{
  unsigned int data;
  struct
  {
...
#define RG_PMU_A8                                 (CHIP_PMU_REG_BASE + 0x20)
// Bit 15  :0      rg_pmu_sleep_wake_bnd          U     RW        default = 'h6
typedef union RG_PMU_A8_FIELD
{
  unsigned int data;
  struct
  {
...
#define RG_PMU_A12                                (CHIP_PMU_REG_BASE + 0x30)
...
typedef union RG_PMU_A12_FIELD
{
  unsigned int data;
  struct
  {
...
#define RG_PMU_A13                                (CHIP_PMU_REG_BASE + 0x34)
...
typedef union RG_PMU_A13_FIELD
{
  unsigned int data;
  struct
  {
...
#define RG_PMU_A14                                (CHIP_PMU_REG_BASE + 0x38)
...
typedef union RG_PMU_A14_FIELD
{
  unsigned int data;
  struct
  {
...
#define RG_PMU_A16                                (CHIP_PMU_REG_BASE + 0x40)
// Bit 31  :0      rg_pmu_power_cfg               U     RW        default = 'h0
typedef union RG_PMU_A16_FIELD
{
  unsigned int data;
  struct
  {
...
#define RG_PMU_A19                                (CHIP_PMU_REG_BASE + 0x4c)
// Bit 7   :0      ro_pwrup_ack                   U     RO        default = 'h0
typedef union RG_PMU_A19_FIELD
{
  unsigned int data;
  struct
  {
...
#define RG_PMU_A20                                (CHIP_PMU_REG_BASE + 0x50)
...
#define RG_PMU_A21                                (CHIP_PMU_REG_BASE + 0x54)
...
#define RG_PMU_A23                                (CHIP_PMU_REG_BASE + 0x5c)
// Bit 7   :0      ro_pmu_sdio_cfg                U     RO        default = 'h0
typedef union RG_PMU_A23_FIELD
{
  unsigned int data;
  struct
  {
...
#define RG_PMU_A24                                (CHIP_PMU_REG_BASE + 0x60)
...
#define RG_PMU_A25                                (CHIP_PMU_REG_BASE + 0x64)
...
#define RG_PMU_A28                                (CHIP_PMU_REG_BASE + 0x70)
// Bit 0           rg_if_reset_val                U     RW        default = 'h0
...
// Bit 10          rg_hif_mode_val                U     RW        default = 'h0
// Bit 11          rg_hif_mode_man                U     RW        default = 'h0
typedef union RG_PMU_A28_FIELD
{
  unsigned int data;
  struct
  {
    unsigned int rg_if_reset_val : 1;
    ...
    unsigned int rg_hif_mode_val : 1;
