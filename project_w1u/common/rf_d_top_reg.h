...
// Bit 30  :29     rg_wf_trswitch_edge_mask       U     RW        default = 'h3
...
// Bit 1           rg_m2_wf_trx_hf_ldo_tx1_en     U     RW        default = 'h0
...
// Bit 18  :17     rg_wf_dac_op_ibias             U     RW        default = 'h1
...
// Bit 18          rg_wf_wadc_clkout_phase        U     RW        default = 'h1
...
// Bit 6   :4      rg_wf_dac_ampctrl_man          U     RW        default = 'h2
...
// Bit 2           rg_m6_wf_trx_hf_ldo_tx2_en     U     RW        default = 'h0
...
#define RG_TOP_A35                                (RF_D_TOP_REG_BASE + 0xa8)
// Bit 3   :0      code_m1                        U     RO        default = 'h0
// Bit 15  :8      code_m2                        U     RO        default = 'h0
// Bit 23  :16     code_m3                        U     RO        default = 'h0
// Bit 31  :24     code_m4                        U     RO        default = 'h0
typedef union RG_TOP_A35_FIELD
{
  unsigned int data;
  struct
  {
    unsigned int code_m1 : 4;
    unsigned int rsvd_0 : 4;
    unsigned int code_m2 : 8;
    unsigned int code_m3 : 8;
    unsigned int code_m4 : 8;
  } b;
} RG_TOP_A35_FIELD_T;

#define RG_TOP_A36                                (RF_D_TOP_REG_BASE + 0xac)
// Bit 7   :0      code_m5                        U     RO        default = 'h0
// Bit 15  :8      code_m6                        U     RO        default = 'h0
// Bit 23  :16     code_m7                        U     RO        default = 'h0
// Bit 31  :24     code_m8                        U     RO        default = 'h0
typedef union RG_TOP_A36_FIELD
{
  unsigned int data;
  struct
  {
    unsigned int code_m5 : 8;
    unsigned int code_m6 : 8;
    unsigned int code_m7 : 8;
    unsigned int code_m8 : 8;
  } b;
} RG_TOP_A36_FIELD_T;

#define RG_TOP_A37                                (RF_D_TOP_REG_BASE + 0xb0)
// Bit 7   :0      code_ap                        U     RO        default = 'h0
typedef union RG_TOP_A37_FIELD
{
  unsigned int data;
  struct
  {
    unsigned int code_ap : 8;
    unsigned int rsvd_0 : 24;
  } b;
} RG_TOP_A37_FIELD_T;

#define RG_TOP_A38                                (RF_D_TOP_REG_BASE + 0xb4)
// Bit 12  :5      rg_wf2g_dac_rsv                U     RW        default = 'h3f
typedef union RG_TOP_A38_FIELD
{
  ...
  struct
  {
    ...
    unsigned int rg_wf2g_dac_rsv : 8;
