...
static unsigned int sts_reg_chk_pool[] = {
            RG_MAC_CNT_CTRL_FIQ,
...
void sts_prt_info_map(void)
{
    ...
    */
    sts_sys_idx_val[sts_mac_irq_txstart_idx] =  (RG_MAC_CNT_CTRL_FIQ & 0xffff )<<16 | IDX_TXSTART_IT;
    sts_sys_idx_val[sts_mac_irq_txend_idx] =  (RG_MAC_CNT_CTRL_FIQ & 0xffff )<<16 |IDX_TXEND_IT;
    sts_sys_idx_val[sts_mac_irq_txenderr_idx] = (RG_MAC_CNT_CTRL_FIQ & 0xffff )<<16 |IDX_TXENDERR;
    sts_sys_idx_val[sts_mac_irq_ackto_idx] = (RG_MAC_CNT_CTRL_FIQ & 0xffff )<<16 |IDX_ACKTO_IT;
    sts_sys_idx_val[sts_mac_irq_txcol_flag_idx ] = (RG_MAC_CNT_CTRL_FIQ & 0xffff )<<16 |IDX_TXCOL_FLAG;
    sts_sys_idx_val[sts_mac_irq_rxstart_idx ] = (RG_MAC_CNT_CTRL_FIQ & 0xffff )<<16 |IDX_RXSTART_IT;
    sts_sys_idx_val[sts_mac_irq_mac_rxend_idx] = (RG_MAC_CNT_CTRL_FIQ & 0xffff )<<16 |IDX_RXEND_IT;
    sts_sys_idx_val[sts_mac_irq_mac_rxmpdu_ok_idx] = (RG_MAC_CNT_CTRL_FIQ & 0xffff )<<16 |IDX_RXMPDU_OK;
    sts_sys_idx_val[sts_mac_irq_unicast_idx ] = (RG_MAC_CNT_CTRL_FIQ & 0xffff )<<16 |IDX_UNICAST;
    sts_sys_idx_val[sts_mac_irq_srambuf_full_idx ] = (RG_MAC_CNT_CTRL_FIQ & 0xffff )<<16 |IDX_SRAMBUF_FULL;
    sts_sys_idx_val[sts_mac_irq_swirq_idx ] = (RG_MAC_CNT_CTRL_FIQ  & 0xffff )<<16 |IDX_SWIRQ;
    sts_sys_idx_val[sts_mac_irq_tx_frame_type_idx ] = (RG_MAC_CNT_CTRL_FIQ & 0xffff )<<16 |IDX_TX_FRAME_TYPE;
    sts_sys_idx_val[sts_mac_irq_abscount_intr_idx ] = (RG_MAC_CNT_CTRL_FIQ & 0xffff )<<16 |IDX_ABSCOUNT_INTR;
    sts_sys_idx_val[sts_mac_irq_fiq_enable_idx] = (RG_MAC_CNT_CTRL_FIQ & 0xffff )<<16 |IDX_FIQ_ENABLE;
    sts_sys_idx_val[sts_mac_irq_fiac_fw_timeout_err_idx] = (RG_MAC_CNT_CTRL_FIQ & 0xffff )<<16 |IDX_FIAC_FW_TIMEOUT_ERR;
    sts_sys_idx_val[sts_mac_irq_hw_timeout_err_idx] = (RG_MAC_CNT_CTRL_FIQ & 0xffff )<<16 |IDX_HW_TIMEOUT_ERR;
    sts_sys_idx_val[sts_mac_irq_tx_wd_timeout_err_idx] = (RG_MAC_CNT_CTRL_FIQ & 0xffff )<<16 |IDX_TX_WD_TIMEOUT_ERR;
    sts_sys_idx_val[sts_mac_irq_txinvalidlen_err_idx] = (RG_MAC_CNT_CTRL_FIQ & 0xffff )<<16 |IDX_TXINVALIDLEN_ERR;
    sts_sys_idx_val[sts_mac_irq_tx_keymiss_idx] =  (RG_MAC_CNT_CTRL_FIQ & 0xffff )<<16 |IDX_TX_KEYMISS;
    sts_sys_idx_val[sts_mac_irq_tximstop_err_idx ] = (RG_MAC_CNT_CTRL_FIQ & 0xffff )<<16|IDX_TXIMSTOP_ERR;
    sts_sys_idx_val[sts_mac_irq_tx_phyerror_idx] = (RG_MAC_CNT_CTRL_FIQ & 0xffff )<<16 |IDX_TX_PHYERROR;
    sts_sys_idx_val[sts_mac_irq_txcol_queue_idx] = (RG_MAC_CNT_CTRL_FIQ & 0xffff )<<16 |IDX_TXCOL_QUEUE;
    sts_sys_idx_val[sts_mac_irq_tx_not_grant_idx] = (RG_MAC_CNT_CTRL_FIQ & 0xffff )<<16|IDX_TX_NOT_GRANT;
    sts_sys_idx_val[sts_mac_irq_srambuf_full_err_idx ] = (RG_MAC_CNT_CTRL_FIQ & 0xffff )<<16|IDX_SRAMBUF_FULL_ERR;
    sts_sys_idx_val[sts_mac_irq_fcserr_idx ] = (RG_MAC_CNT_CTRL_FIQ & 0xffff )<<16 |IDX_FCSERR;
    sts_sys_idx_val[sts_mac_irq_rxfifoov_idx ] = (RG_MAC_CNT_CTRL_FIQ & 0xffff )<<16|IDX_RXFIFOOV;
    sts_sys_idx_val[sts_mac_irq_rx_wd_timeout_err_idx ] = (RG_MAC_CNT_CTRL_FIQ & 0xffff )<<16 |IDX_RX_WD_TIMEOUT_ERR;
    sts_sys_idx_val[sts_mac_irq_short_length_idx] =  (RG_MAC_CNT_CTRL_FIQ & 0xffff )<<16 |IDX_SHORT_LENGTH;
    sts_sys_idx_val[sts_mac_irq_length_error_idx ] = (RG_MAC_CNT_CTRL_FIQ & 0xffff )<<16 |IDX_LENGTH_ERROR;
    sts_sys_idx_val[sts_mac_irq_rx_phyerror_idx ] = (RG_MAC_CNT_CTRL_FIQ & 0xffff )<<16 |IDX_RX_PHYERROR;
    sts_sys_idx_val[sts_frm_type_qos_data_idx ] = (RG_MAC_FRM_TYPE_CNT_CTRL & 0xffff)<< 16 | IDX_QOS_DATA;
    sts_sys_idx_val[sts_frm_type_rts_idx ] =  (RG_MAC_FRM_TYPE_CNT_CTRL & 0xffff)<< 16 | IDX_RTS;
    sts_sys_idx_val[sts_frm_type_cts_idx] =   (RG_MAC_FRM_TYPE_CNT_CTRL & 0xffff)<< 16 | IDX_CTS;
    sts_sys_idx_val[sts_frm_type_ack_idx] =   (RG_MAC_FRM_TYPE_CNT_CTRL & 0xffff)<< 16 | IDX_ACK;
    ...
    sts_sys_idx_val[sts_agc_st_idx] = ((RG_AGC_STATE & 0xffff) << 16) |  sts_agc_st_idx;
    sts_sys_idx_val[sts_agc_gain_rx_ic_gain_idx] = ( (RG_AGC_OB_IC_GAIN & 0xffff) << 16) |  sts_agc_gain_rx_ic_gain_idx;
    sts_sys_idx_val[sts_agc_gain_fine_db_idx] =  ((RG_AGC_OB_IC_GAIN & 0xffff) << 16) |  sts_agc_gain_fine_db_idx;
    sts_sys_idx_val[sts_agc_wtc1_pw_sat_db_idx] = ( (RG_AGC_WATCH1 & 0xffff) << 16) |  sts_agc_wtc1_pw_sat_db_idx;
    sts_sys_idx_val[sts_agc_wtc1_prm20_db_idx] =  ((RG_AGC_WATCH1 & 0xffff) << 16) |  sts_agc_wtc1_prm20_db_idx;
    sts_sys_idx_val[sts_agc_wtc2_prm40_db_idx] =  ((RG_AGC_WATCH2 & 0xffff) << 16) |  sts_agc_wtc2_prm40_db_idx;
    sts_sys_idx_val[sts_agc_wtc2_prm80_db_idx] =  ((RG_AGC_WATCH2 & 0xffff) << 16) |  sts_agc_wtc2_prm80_db_idx;
    sts_sys_idx_val[sts_agc_wtc3_rssi0_db_idx] =  ((RG_AGC_WATCH3 & 0xffff) << 16) |  sts_agc_wtc3_rssi0_db_idx;
    sts_sys_idx_val[sts_agc_wtc3_rssi1_db_idx] =  ((RG_AGC_WATCH3 & 0xffff) << 16) |  sts_agc_wtc3_rssi1_db_idx;
    sts_sys_idx_val[sts_agc_wtc4_rssi2_db_idx] =  ((RG_AGC_WATCH4 & 0xffff) << 16) |  sts_agc_wtc4_rssi2_db_idx;
    sts_sys_idx_val[sts_agc_wtc4_rssi3_db_idx] =  ((RG_AGC_WATCH4 & 0xffff) << 16) |  sts_agc_wtc4_rssi3_db_idx;
    sts_sys_idx_val[sts_agc_ant_flr_snr_qdb_idx] =  ((RG_AGC_OB_ANT_NFLOOR & 0xffff) << 16) |sts_agc_ant_flr_snr_qdb_idx;

    sts_sys_idx_val[sts_agc_ant_flr_ant_flr_qdb_idx] =  ((RG_AGC_OB_ANT_NFLOOR & 0xffff) << 16) | sts_agc_ant_flr_ant_flr_qdb_idx;
    sts_sys_idx_val[sts_cca_res_rdy_idx] =  ((RG_AGC_OB_CCA_RES & 0xffff) << 16) |sts_cca_res_rdy_idx;
    sts_sys_idx_val[sts_cca_res_cond8_idx] =  ((RG_AGC_OB_CCA_RES & 0xffff) << 16) | sts_cca_res_cond8_idx;
    sts_sys_idx_val[sts_cca_cnd01_cond0_idx] =  ((RG_AGC_OB_CCA_COND01 & 0xffff ) << 16) |sts_cca_cnd01_cond0_idx;
    sts_sys_idx_val[sts_cca_cnd01_cond1_idx] =  ((RG_AGC_OB_CCA_COND01  & 0xffff ) << 16) | sts_cca_cnd01_cond1_idx;
    sts_sys_idx_val[sts_cca_cnd23_cond2_idx] =  ((RG_AGC_OB_CCA_COND23 & 0xffff) << 16) |sts_cca_cnd23_cond2_idx;
    sts_sys_idx_val[sts_cca_cnd23_cond3_idx] =  ((RG_AGC_OB_CCA_COND23 & 0xffff) << 16) | sts_cca_cnd23_cond3_idx;
...
*/
 char** get_tag_info(unsigned int addr, unsigned int tag_info)
{
...
*/
void sts_clr_cnt(unsigned int addr)
{
    int i = 0;
    int chg_data = 0;
    int bk_data = 0;
...
@char obj_3  index 3
*/
void sts_start_cnt(unsigned int addr,
...
void sts_prt_agc_field(unsigned int addr,
...
@char obj_3  index 3
*/
void sts_read_cnt(unsigned int addr,
...
@addr: the statistic register address
*/
void sts_stop_cnt(unsigned int addr)
{
    int i = 0;
    unsigned int chg_data = 0;
    struct  cnt_ctrl_bits* cnt_ctrl = NULL;
